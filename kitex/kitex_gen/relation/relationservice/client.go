...
type Client interface {
	...
	FollowingList(ctx context.Context, request *relation.FollowingListRequest, callOptions ...callopt.Option) (r *relation.FollowingListResponse, err error)
	FollowerList(ctx context.Context, request *relation.FollowerListRequest, callOptions ...callopt.Option) (r *relation.FollowerListResponse, err error)
...
func (p *kRelationServiceClient) FollowingList(ctx context.Context, request *relation.FollowingListRequest, callOptions ...callopt.Option) (r *relation.FollowingListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.FollowingList(ctx, request)
}

func (p *kRelationServiceClient) FollowerList(ctx context.Context, request *relation.FollowerListRequest, callOptions ...callopt.Option) (r *relation.FollowerListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
